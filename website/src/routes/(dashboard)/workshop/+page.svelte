    ...
    <div class="pb-12">
        <div class="space-y-4 py-4">
            <div class="px-3 py-2">
                ...
                <div class="space-y-1">
                    <TabButton isActive={tab === WorkshopTab.SKILLS} on:click={() => state.setTab(WorkshopTab.SKILLS)}>
                        <Hammer class="w-4 mr-2"/>
                        Skills
                    </TabButton>
                    <TabButton isActive={tab === WorkshopTab.AGENTS} on:click={() => state.setTab(WorkshopTab.AGENTS)}>
                        <User class="w-4 mr-2"/>
                        Agents
                    </TabButton>
<!--                    <TabButton isActive={tab === WorkshopTab.TASKS} on:click={() => state.setTab(WorkshopTab.TASKS)}>-->
