<script>
    import {workshopStore} from "$lib/services/workshop-service.ts";
    import {Button} from "$components/button/index.ts";
    import AgentCard from "./agent-card.svelte";
    import CreateAgentCard from "./create-agent-card.svelte";
    import AgentLoader from "./agent-loader.svelte";
